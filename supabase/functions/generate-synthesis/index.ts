...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (isDirectMode) {
      ...
      // Resolve heart_type: profiles stores a number (1-9), map to name
      ...
      // Look up synthesis routing fields from latest heart_assessments row
      ...
      // Guard: two-candidate result — synthesis does not fire
